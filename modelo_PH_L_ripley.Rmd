...
pontos num plano: Poisson homogêneo, Poisson não-homogêneo, Thomas
homogêneo e Thomas não-homogêneo. Estes modelos são úteis para
descrever, entre outros padrões, a estrutura espacial de plantas. Por
exemplo, se descobrimos que o modelo Thomas homogêneo aproxima bem a
...
a fase adulta é afetada por alguma característica do ambiente, que
varia na área.
