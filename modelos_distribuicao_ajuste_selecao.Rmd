...
em escala logarítimica. O comando a seguir exibe este valor:
...
comandos abaixo usam o modelo que ajusatmos para fazer isso, e exibir
...
fácil de preceber no mapa de pontos.
...
[^1]: Mais especificamente, este modelo ajusta uma relação exponencial
    ...
    independente (no caso o conteúdo de matéria orgância) e $a_0$ e
    $a_1$ são os coeficientes da função, cujos valors é estimado pela
