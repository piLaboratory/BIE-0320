...
![](images/richards_1_2_perfil_tropi_temperada.jpg?450)


Uma das técnicas utilizadas para quantificar a importância relativa de
diferentes fatores é **Partição da Variação** e ela pode ser aplicada
...
Para fazer a prática, siga os seguintes roteiros:
  ...
  - [Coeficiente de determinação](coeficiente_determinação.html), o
    conceito que está na base da partição de variação;
  - [Partição de variação com uma espécie], em que a ideia é
