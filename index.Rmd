...
Aqui estão os links para os três roteiros desta prática:

* [Simulação de padrões de pontos no espaço](simulacao_pontos_no_espaco.html)
* [O índice L de Ripley](modelo_PH_L_ripley.html)
* [Modelos de distribuição de pontos no espaço](modelos_distribuicao_ajuste_selecao.html)
