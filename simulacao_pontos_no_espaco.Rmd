...
Podemos modificar os comandos acima para descobrir o que os
...
#### DICA
Para mudar o valor de um parâmetro na simulação de padrão de
pontos, você deve alterar os argumentos do primeiro comando:

`TH3 <- rThomas(kappa = 10, scale = 0.03, mu = 10, win = unit.square())`

Este comando cria um objeto chamado `TH3`, com o padrão. Os comandos
seguintes apenas criam um gráfico com o padrão criado com este
comando.
