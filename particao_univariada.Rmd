...
retângulo externo. A parte não coberta pelos círculos é a variação que não é
...
# Conclusão
Abaixo o diagram de Venn da partição da variação na abundância de 
*Non illum* nos componentes que definimos neste roteiro:
